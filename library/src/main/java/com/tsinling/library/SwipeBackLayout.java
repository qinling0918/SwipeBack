...
public class SwipeBackLayout extends ViewGroup {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        weChatStyle = a.getBoolean(R.styleable.SwipeBackLayout_isWeChatStyle, weChatStyle);
        a.recycle();
    }
    ...
    /**
     * 滑动时显示上一页时的阴影 透明度  0 完全透明 ～  255 完全不透明
     * @param maskAlpha
     */
    ...
    /**
     * 设置偏移，当达到该值，则自动滑动
     * @param autoFinishedVelocityLimit
     */
    ...
    /**
     * 设置微信侧滑风格
     * @param weChatStyle true  开启微信侧滑风格
     */
    public void setWeChatStyle(boolean weChatStyle) {
        this.weChatStyle = weChatStyle;
        setSwipeBackListener(defaultSwipeBackListener);
    }
    ...
    private void hintInit() {
        if (BuildConfig.DEBUG){
            throw new IllegalStateException("please init first (ActivityStack.getInstance.init(this) in Application )");
        }
    }
