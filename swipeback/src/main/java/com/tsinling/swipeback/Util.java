...
public class Util {
    ...
    public static boolean isInit() {
       return getActivityStack().isInit();
    }

    public static Activity getPenultimateActivity(){
        int size = getActivityStack().stackSize();
        return size > 1 ? getActivityStack().getStack().get(size - 2).get() : null;
    }

    private static ActivityStack getActivityStack() {
